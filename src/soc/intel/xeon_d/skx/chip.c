...
static struct device_operations pci_domain_ops = {
	...
	.set_resources = &xeond_pci_domain_set_resources,
	.scan_bus = &xeond_pci_domain_scan_bus,
#if CONFIG(HAVE_ACPI_TABLES)
...
{
#if 0 // XXX JJD, ucode update from IFWI table, so ignore for now
...
struct chip_operations soc_intel_xeon_d_skx_ops = {
	CHIP_NAME("Intel Skylake-D")
